...
//
//     final submittedTextAssignmentModel = submittedTextAssignmentModelFromJson(jsonString);

//used to fetch the data od submitted text assignment

import 'dart:convert';

SubmittedTextAssignmentModel submittedTextAssignmentModelFromJson(String str) => SubmittedTextAssignmentModel.fromJson(json.decode(str));

String submittedTextAssignmentModelToJson(SubmittedTextAssignmentModel data) => json.encode(data.toJson());

class SubmittedTextAssignmentModel {
    bool? status;
    String? message;
    List<Datum>? data;
    ...
    factory SubmittedTextAssignmentModel.fromJson(Map<String, dynamic> json) => SubmittedTextAssignmentModel(
        status: json["status"],
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        textAssignmentList: json["textAssignmentList"] == null ? [] : List<DatumTextAssignmentList>.from(json["textAssignmentList"]!.map((x) => DatumTextAssignmentList.fromJson(x))),
        ...
        notSubmittedStudentList: json["notSubmittedStudentList"] == null ? [] : List<NotSubmittedStudentList>.from(json["notSubmittedStudentList"]!.map((x) => NotSubmittedStudentList.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "notSubmittedStudentList": notSubmittedStudentList == null ? [] : List<dynamic>.from(notSubmittedStudentList!.map((x) => x.toJson())),
...
class NotSubmittedStudentList {
    ...
    factory NotSubmittedStudentList.fromJson(Map<String, dynamic> json) => NotSubmittedStudentList(
        id: json["_id"],
        institutionId: json["institutionId"],
        schoolName: json["schoolName"],
        schoolId: json["schoolId"],
...
class SubmittedStudentId {
    ...
    factory SubmittedStudentId.fromJson(Map<String, dynamic> json) => SubmittedStudentId(
        ...
        textAssignmentList: json["textAssignmentList"] == null ? [] : List<SubmittedStudentIdTextAssignmentList>.from(json["textAssignmentList"]!.map((x) => SubmittedStudentIdTextAssignmentList.fromJson(x))),
        isDone: json["isDone"],
        id: json["_id"],
        createdAt: json["createdAt"] == null ? null : DateTime.parse(json["createdAt"]),
        updatedAt: json["updatedAt"] == null ? null : DateTime.parse(json["updatedAt"]),
...
class SubmittedStudentIdTextAssignmentList {
    ...
    factory SubmittedStudentIdTextAssignmentList.fromJson(Map<String, dynamic> json) => SubmittedStudentIdTextAssignmentList(
...
class DatumTextAssignmentList {
    ...
    factory DatumTextAssignmentList.fromJson(Map<String, dynamic> json) => DatumTextAssignmentList(
        question: json["question"],
    );
