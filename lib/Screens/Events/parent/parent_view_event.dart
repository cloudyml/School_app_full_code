...
class _EventScreen extends State<ParentsViewEvents> {
          ...
          children: [
            ...
            Visibility(
              ...
              child: FutureBuilder<StudentsViewEventsResponseModel>(
                future: ApiServices.parentViewSchoolEvents("Pending"),
                          ...
                          itemBuilder: (context, index) {
                            return EventCard(
                              ...
                              time: upcomingEventsData.data![index].eventTime
                                  .toString(),
                              onPressed: () {
                                log(upcomingEventsData!.data!.length
                                    .toString());
            ...
            Visibility(
              visible: !isUpcomingSelected,
              child: FutureBuilder(
                future: ApiServices.parentViewSchoolEvents("Completed"),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    return const CircularProgressIndicator(); // Show loading indicator
                  } else if (snapshot.hasError) {
