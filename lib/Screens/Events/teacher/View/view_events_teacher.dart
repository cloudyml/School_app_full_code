                          ...
                          itemBuilder: (context, index) {
                            return TeacherEventCard(
                              ...
                              time: upcomingEventsData.data![index].eventTime
                                  .toString(),
                              onPressedEnrolledStudents: () {
                                Navigator.push(context, MaterialPageRoute(
                                  builder: (context) {
                                    return TeacherSeeEventEnrolledStudents(
                                        eventID: upcomingEventsData
                                            .data![index].id
                                            .toString());
                                  },
                                ));
                              ...
                              onPressed: () {
                                ...
                                for (var i = 0;
                                    ...
                                    i++) {
                                  completedEventsPics.add(upcomingEventsData
