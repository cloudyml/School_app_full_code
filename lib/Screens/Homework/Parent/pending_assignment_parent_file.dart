  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: FutureBuilder<StudentViewAssignmentModel>(
          future: ApiServices.parentViewPendingAssignmentFile(type, form),
