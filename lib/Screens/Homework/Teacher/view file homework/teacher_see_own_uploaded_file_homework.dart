  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<TeacherSeeOwnAssignmentsListModel>(
        future: TeacherApiServices.teacherSeeOwnGivenFileAssignment(
            wclass, section),
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return TeacherSeeOwnUploadedAssignmentCard(
                  ...
                  section: section,
                  wclass: wclass,
                  questionFile: teacherSeeAllAssignment.data?[index].uploadedImage
                          .toString() ??
                      "",
                  submittedStudentList: teacherSeeAllAssignment.data![index]
                      .submittedStudentId as List<SubmittedStudentId>,
