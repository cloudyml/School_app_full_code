...
import 'Edit_ Student/student_edit_own_details.dart';

class StudentMyAccount extends StatelessWidget {
  const StudentMyAccount({super.key});
            ...
            Column(
              children: [
                          ...
                          onPressed: () {
                            if (SharedService.loginDetails()
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) =>
                                      const EditStudentAccountDetails()));
                            }
                          },
                ...
                InkWell(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const ViewAboutSchool()));
                  },
                  child: Container(
                    height: MediaQuery.of(context).size.height * 0.11,
                    width: MediaQuery.of(context).size.width * 0.9,
