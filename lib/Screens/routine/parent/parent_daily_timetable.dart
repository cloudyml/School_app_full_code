...
class ParentDailyRoutine extends StatefulWidget {
  const ParentDailyRoutine({Key? key}) : super(key: key);

  @override
  State<ParentDailyRoutine> createState() => _ParentDailyRoutineState();
}

class _ParentDailyRoutineState extends State<ParentDailyRoutine> {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: FutureBuilder<StudentEachdayRoutineModel>(
          future: ApiServices.parentViewEachDayRoutine(),
