...
class Friday extends StatefulWidget {
  ...
  @override
  State<Friday> createState() => _MondayState();
}
...
class _MondayState extends State<Friday> {
  ...
  Future<void> fetchData() async {
    final apiUrl = Uri.parse(
        "http://13.232.53.26:3000/teacher/${TeacherSharedServices.loginDetails()?.data?.id}/dayWiseTimeTable?class=${widget.selectedClass}&day=Friday&section=${widget.selectedSection}");
