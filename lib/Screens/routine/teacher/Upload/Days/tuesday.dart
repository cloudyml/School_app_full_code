...
class Tuesday extends StatefulWidget {
  ...
  @override
  State<Tuesday> createState() => _MondayState();
}

class _MondayState extends State<Tuesday> {
  ...
  Future<void> fetchData() async {
    final apiUrl = Uri.parse(
        "http://13.232.53.26:3000/teacher/${TeacherSharedServices.loginDetails()?.data?.id}/dayWiseTimeTable?class=${widget.selectedClass}&day=Tuesday&section=${widget.selectedSection}");
