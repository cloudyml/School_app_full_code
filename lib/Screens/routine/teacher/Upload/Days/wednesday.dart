...
class Wednesday extends StatefulWidget {
  ...
  @override
  State<Wednesday> createState() => _MondayState();
}
...
class _MondayState extends State<Wednesday> {
  ...
  Future<void> fetchData() async {
    final apiUrl = Uri.parse(
        "http://13.232.53.26:3000/teacher/${TeacherSharedServices.loginDetails()?.data?.id}/dayWiseTimeTable?class=${widget.selectedClass}&day=Wednesday&section=${widget.selectedSection}");
