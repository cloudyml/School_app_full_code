...
import 'package:school_management_system/Screens/routine/teacher/View/teacher_view_timetable.dart';
...
class TeacherChooseClassForViewTimetable extends StatefulWidget {
  ...
  @override
  State<TeacherChooseClassForViewTimetable> createState() =>
      _ChooseClassForTakeAttendanceState();
}

class _ChooseClassForTakeAttendanceState
    extends State<TeacherChooseClassForViewTimetable> {
                  ...
                  onPressed: () {
                    if (selectedClass == 'Choose Class' ||
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => TeacherViewDayWiseRoutine(
