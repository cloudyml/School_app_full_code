...
import 'package:school_management_system/Models/Student/day_Routine_response_medel.dart';
import 'package:school_management_system/Services/api_services/api_services.dart';
import 'package:school_management_system/constants/style.dart';
import 'package:school_management_system/widget/appBar/appbar_widget.dart';
import 'package:school_management_system/widget/appBar/decorative_apbar_widget.dart';

class TeacherViewDayWiseRoutine extends StatefulWidget {
  final String wclass;
  final String section;
  const TeacherViewDayWiseRoutine(
      {super.key, required this.wclass, required this.section});

  @override
  State<TeacherViewDayWiseRoutine> createState() =>
      _TeacherViewDayWiseRoutineState();
}

class _TeacherViewDayWiseRoutineState extends State<TeacherViewDayWiseRoutine> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<StudentEachdayRoutineModel>(
        future: ApiServices.TeacherSeeDayRoutine(widget.wclass, widget.section),
